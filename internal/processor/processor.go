...
func isBuiltInValidator(validator string) bool {
	builtInValidators := map[string]bool{
		// 自定义验证器 (项目内自定义，不是go-playground/validator内置)
		"mobile": true,
		"idcard": true,
		...
		"bic":                           true,
		"semver":                        true,
		"dns_rfc1035_label":             true,
		"timezone":                      true,
		"iso3166_1_alpha2":              true,
		"iso3166_1_alpha3":              true,
		"iso3166_1_alpha_numeric":       true,
		"bcp47_language_tag":            true,
		"postcode_iso3166_alpha2":       true,
		"postcode_iso3166_alpha2_field": true,
		"e164":                          true,
		"country_code":                  true,
	}

	// 检查是否是带参数的内置验证器，如 min=10, datetime=2006-01-02
